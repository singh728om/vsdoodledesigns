...
function(t) {
    ...
    t(document).on("click", ".sppb-panel-heading", function(e) {
        ...
        t(this).hasClass("active") ? (t(this).removeClass("active"), s.slideUp()) : (n.removeClass("active"), s.slideUp(), t(this).addClass("active").next().slideDown())
    })
}(jQuery),
function(t) {
    "use strict";
            ...
            return e.find(" input[type=text], input[type=email], input[type=radio], input[type=checkbox], textarea, select").each(function(e, a) {
                ...
                if (n) t(this).on("change keyup", function() {
                    var e = t(this).val().replace(/\s/g, ""),
                        n = t(this).attr("type"),
                        a = t(this).attr("name");
                    "" === e || 0 === e.length ? (s = !0, t(this).addClass("sppb-has-field-error")) : (s = !1, t(this).removeClass("sppb-has-field-error")), "text" !== n || "captcha_question" === a || "phone" === a || isNaN(e) || s ? (s = !1, t(this).removeClass("sppb-has-field-error")) : (s = !0, console.log("fieldname: ", a), t(this).addClass("sppb-has-field-error")), void 0 !== t(this).prop("required") && e.length > 0 && "email" === n && !s && (i(e) ? (t(this).removeClass("sppb-has-field-error"), s = !1) : (t(this).addClass("sppb-has-field-error"), s = !0))
                });
                else {
        ...
        window.sppbVideoBackgroundResize = function(t) {
            ...
            n.length > 0 && n.each(function() {
                var e = t("#section-id-" + t(this).data("rowid")),
                    ...
                    n = t("#column-wrap-id-" + t(this).data("colid")),
    ...
    function(t) {
        t.fn.basictable = function(e) {
            ...
            var i = this,
                ...
                s = i.find("tbody"),
                a = n.perPage,
                o = i.hasClass("sppb-no-table-header"),
                r = s.children(),
                l = t(".pager");
            ...
            t(".sppb-addon-table-main").length > 0 && t(".sppb-addon-table-main").each(function(e) {
                var i = t(this).data("responsive"),
                    n = !i;
                console.log(n), t(this).basictable({
                    showEmptyCells: !1,
                    forceResponsive: i,
                    noResize: n
                });
